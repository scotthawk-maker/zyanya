...
(async () => {
    ...
    console.info(`Full zyanya address: ${sourceAddress}`);
    ...
    if (!entries.length) {
        ...
        //
        // If the requested amount is greater than the Zyanya
        ...
        let generator = new Generator({
            entries,
            outputs: [{ address : sourceAddress, amount : zyanyaToSompi(0.2)}],
