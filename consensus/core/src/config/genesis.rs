...
pub const MAINNET_GENESIS: GenesisBlock = GenesisBlock {
    hash: Hash::from_bytes([
        0x99, 0xF5, 0xE7, 0xF1, 0xE1, 0xF3, 0x2E, 0xFD, 0xBA, 0x33, 0xA5, 0x5A, 0x6B, 0xCD, 0x18, 0x6B, 0xAE, 0xE9, 0x82, 0x7A, 0x63,
        0xC8, 0xDD, 0x17, 0x3C, 0xB2, 0x72, 0x13, 0x67, 0xC5, 0x78, 0x15,
    ]),
    version: 0,
    hash_merkle_root: Hash::from_bytes([
        0xE7, 0x7C, 0x8E, 0x7C, 0xBE, 0x98, 0xE9, 0xB0, 0x48, 0xF8, 0x81, 0x63, 0x81, 0x96, 0x38, 0x67, 0x3A, 0xD7, 0xCC, 0xDF, 0xE5,
        0xCF, 0xBB, 0x98, 0x78, 0x0A, 0x2D, 0x1A, 0x51, 0xA6, 0xF5, 0xCE,
    ]),
...
pub const TESTNET_GENESIS: GenesisBlock = GenesisBlock {
    hash: Hash::from_bytes([
        0xC6, 0x86, 0x6E, 0x0B, 0xA3, 0x07, 0x59, 0x96, 0xF0, 0x66, 0x9B, 0xD7, 0xBD, 0xC2, 0x6C, 0x00, 0x08, 0x6D, 0x8C, 0xD3, 0x45,
        0xDD, 0xA6, 0xF1, 0xBE, 0x04, 0xF4, 0x03, 0xAF, 0x25, 0xCF, 0x6A,
    ]),
    version: 0,
    hash_merkle_root: Hash::from_bytes([
        0xCD, 0x03, 0x30, 0x09, 0x64, 0xE7, 0xA6, 0x55, 0xCE, 0x2D, 0x57, 0x09, 0xA5, 0xA5, 0xD7, 0x3C, 0xC1, 0x79, 0xF6, 0x68, 0x13,
        0xFF, 0xB1, 0x40, 0x2B, 0x3F, 0x03, 0x2F, 0x75, 0xA8, 0x06, 0x8E,
    ]),
    utxo_commitment: EMPTY_MUHASH,
    timestamp: 1770000000000,
...
mod tests {
    ...
    fn test_genesis_hashes() {
        [MAINNET_GENESIS, GENESIS, TESTNET_GENESIS, TESTNET11_GENESIS, SIMNET_GENESIS, DEVNET_GENESIS].into_iter().for_each(
            |genesis| {
