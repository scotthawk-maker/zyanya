...
pub enum Error {
    ...
    #[error(transparent)]
    WrpcError(#[from] zyanya_wrpc_client::error::Error),

    #[error(transparent)]
    RpcError(#[from] zyanya_rpc_core::RpcError),
    ...
    #[error(transparent)]
    Daemon(#[from] zyanya_daemon::error::Error),
    ...
    #[error(transparent)]
    Bip32(#[from] zyanya_bip32::Error),

    #[error("private key {0} already exists")]
    PrivateKeyAlreadyExists(String),

    #[error(transparent)]
    MetricsError(zyanya_metrics_core::error::Error),

    #[error(transparent)]
    ZyanyaWalletKeys(#[from] zyanya_wallet_keys::error::Error),

    #[error(transparent)]
    PssbLockScriptSigError(#[from] zyanya_wallet_psst::error::Error),
