...
use zyanya_core::zyanyad_env::version;
...
impl Args {
    pub fn apply_to_config(&self, config: &mut Config) {
        ...
        // F-C-13: Optional bearer-token auth for state-changing RPC methods.
    ...
    #[cfg(feature = "devnet-prealloc")]
    pub fn generate_prealloc_utxos(&self, num_prealloc_utxos: u64) -> zyanya_consensus_core::utxo::utxo_collection::UtxoCollection {
...
pub fn cli() -> Command {
    ...
    let cmd = Command::new("zyanyad")
        .about(format!("{} (rusty-zyanya) v{}", env!("CARGO_PKG_DESCRIPTION"), version()))
...
/*
  ...
  -a, --addpeer=                            Add a peer to connect with at startup
      ...
      --rpccert=                            File containing the certificate file (default:
                                            /Users/aspect/Library/Application Support/Zyanyad/rpc.cert)
      --rpckey=                             File containing the certificate key (default:
                                            /Users/aspect/Library/Application Support/Zyanyad/rpc.key)
  ...
  -d, --loglevel=                           Logging level for all subsystems {trace, debug, info, warn, error,
      ...
      --minrelaytxfee=                      The minimum transaction fee in ZYAN/kB to be considered a non-zero fee.
                                            (default: 1e-05)
