...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let app = Router::new()
        ...
        .route("/api/token/:address/graduation", get(api_token_graduation_handler))
        ...
        .route("/api/unsigned-stake", post(api_unsigned_stake_handler))
        .route("/api/unsigned-unstake", post(api_unsigned_unstake_handler))
        .route("/api/unsigned-claim-rewards", post(api_unsigned_claim_rewards_handler))
