...
async fn export_multisig_account(ctx: Arc<ZyanyaNodeCli>, account: Arc<MultiSig>) -> Result<()> {
...
async fn export_single_key_account(ctx: Arc<ZyanyaNodeCli>, account: Arc<dyn Account>) -> Result<()> {
